...
class BlogListView(PermissionRequiredMixin, views.View):
...
class BlogDetailView(PermissionRequiredMixin, views.View):
    permission_required = ["blogs.view_blog"]
...
class BlogCreateView(PermissionRequiredMixin, views.View):
...
class BlogEditView(PermissionRequiredMixin, views.View):
...
class BlogDeleteView(PermissionRequiredMixin, views.View):
