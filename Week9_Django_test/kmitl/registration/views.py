...
def create_student(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            st1 = Student.objects.create(student_id = student_id,first_name = first_name,last_name = last_name,faculty=fac)
            stp1 = StudentProfile.objects.create(student =st1,email = email,phone_number = phone_number,address = address)

            for i in enrolled_sections:
